...
#define SW_VERSION 1.00                     // Версия ПО устройства. Буду стараться периодически обновлять и улучшать код, поэтому рекомендую время от времени проверять наличие новых версий ПО
...
#define GPS_UART 9600         // Скорость шины UART в зависимости от настроек GPS модуля. Смотреть в программе u-center на компьютере. Обычно по-умолчанию - 9600, но может и отличаться. Можно настроить самому в программе u-center
